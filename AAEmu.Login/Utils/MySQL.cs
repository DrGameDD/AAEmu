...
namespace AAEmu.Login.Utils
{
    public static class MySQL
    {
        ...
        static MySQL()
        {
            ...
            ConnectionString =
                $"server={config.Host};port={config.Port};user={config.User};password={config.Password};database={config.Database};Pooling=true;Min Pool Size=0;Max Pool Size=10;Connection Lifetime=600;charset=utf8;Allow Zero Datetime=true;Convert Zero Datetime=true;default command timeout=180;SslMode=none;allowPublicKeyRetrieval=true";
        }
